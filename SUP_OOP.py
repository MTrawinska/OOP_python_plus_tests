...
class SUP(SurfingBoard):
    ...
    def __init__(self, sup_weight, user_weight, gear_weight, user_number,_sup_type):
        super(SUP, self).__init__(sup_weight, user_weight, gear_weight)
        self.user_number = user_number
        self._sup_type = _sup_type
...
my_iter = iter(sup)
print("1.", my_iter.__next__())
print("2.", my_iter.__next__())
print("3.", my_iter.__next__())
print("4.", my_iter.__next__())
# print(my_iter.__next__()) > will throw "StopIteration"
print("---Show chosen SUP type---")
type = sup.sup_type
print(type)
# sup.sup_type ="mess"
# print(sup.sup_type) -> Just to show setter, will show "ValueError: Incorrect SUP type please type: epoxy/ inflatable/ soft_top /other"
